...
class Encoder<Tempest::CommandBuffer> {
  public:
    ...
    void setBinding(size_t id, const Texture2d&       tex, const ComponentMapping& m, const Sampler& smp = Sampler::anisotrophy());
    ...
    void setBinding(size_t id, const Detail::ResourcePtr<Texture2d>& tex, const ComponentMapping& m = ComponentMapping(), const Sampler& smp = Sampler::anisotrophy());
