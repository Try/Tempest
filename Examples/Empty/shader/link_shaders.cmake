...
foreach(i ${SOURCES})
  ...
  file(APPEND ${HEADER} "  static const AppShader ${CLEAN_NAME};\n")
endforeach()
file(APPEND ${HEADER} "  static AppShader get(const char* name);\n")
file(APPEND ${HEADER} "  };\n")

file(APPEND ${HEADER} "inline AppShader AppShader::get(const char* name) {\n")
foreach(i ${SOURCES})
  get_filename_component(NAME ${i} NAME)
  string(REPLACE "." "_" CLEAN_NAME ${NAME})
...
foreach(i ${SOURCES})
  get_filename_component(NAME ${i} NAME)
  string(REPLACE "." "_" CLEAN_NAME ${NAME})
  file(APPEND ${CPP} "const AppShader AppShader::${CLEAN_NAME} = {")
